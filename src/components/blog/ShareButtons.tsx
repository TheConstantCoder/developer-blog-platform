  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div className="flex items-center">
        <ShareIcon className="w-5 h-5 text-gray-500 dark:text-gray-400 mr-3" />
      ...
      <div className="flex items-center space-x-2">
        ...
        {shareLinks.map((link) => (
          <button
            ...
            className={`p-2 rounded-lg border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 transition-all duration-200 ${link.color}`}
        ...
        <button
          ...
          className="flex items-center px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200"
          title="Copy link"
        >
          {copied ? (
            <>
